...
public class SkillWantLearnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skill_want_learn);

        skillsContainer = findViewById(R.id.skills_container);
        btnNext = findViewById(R.id.btn_next);

        // Get skills from previous screen
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!selectedSkills.isEmpty()) {
                    Intent intent = new Intent(SkillWantLearnActivity.this, TimeInvestmentActivity.class);
                    intent.putStringArrayListExtra("skills_you_know", skillsYouKnow);
                    intent.putStringArrayListExtra("skills_want_learn", (ArrayList<String>) selectedSkills);
